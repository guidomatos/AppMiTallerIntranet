...
/// <reference path="../../Images/arrowdown.gif" />
...
tiparrow.style.left=(edgeoffsetx!=0)? parseInt(dropmenuobj.style.left)+dropmenuobj.offsetWidth-tiparrow.offsetWidth-0+"px" : parseInt(dropmenuobj.style.left)-5+"px"

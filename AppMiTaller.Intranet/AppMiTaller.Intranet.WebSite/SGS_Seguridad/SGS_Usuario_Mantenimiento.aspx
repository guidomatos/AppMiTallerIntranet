...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fc_Grabar()
        {
            try
            {
                ...
                if(document.getElementById("<%=trUbicacionDependiente.ClientID %>").style.display != "none"){
                    if (fc_Trim(document.getElementById("<%=this.cboUbicacionDependiente.ClientID %>").value) == ""  )
                            mstrError += mstrDebeSeleccionar + "la ubicación del usuario.\n";
                } 
                ...
                cbo_empresa = document.getElementById("<%=cbo_empresa.ClientID%>");
                vi_co_empresa = "";
                vl_no_empresa = "";

                for (var i = 0; i < cbo_empresa.options.length; i++) {
                    var optionMG = cbo_empresa.options[i];
                    var valMG = fc_Trim(optionMG.value);
                    var txtMG = fc_Trim(optionMG.text);
                    if (optionMG.selected) {
                        vi_co_empresa = vi_co_empresa + "," + valMG;
                        vl_no_empresa = vl_no_empresa + ", " + txtMG;
                    }
                }
                vi_co_empresa = vi_co_empresa + ",";                
              
                if (cleanArray(vi_co_empresa.split(",")).length == 0){
                    mstrError += "- Debe asignar por lo menos una empresa retail \n";  
                }                
        ...
        function fc_ShowDetalleRol() {
            objComboRol = "<%=this.ConstTipo %>";
            document.getElementById("<%=trJefeVenta.ClientID %>").style.display = "none";
            document.getElementById("<%=trHrJefeVenta.ClientID %>").style.display = "none";
            document.getElementById("<%=trAlmacenera.ClientID %>").style.display = "none";
            document.getElementById("<%=trAgente.ClientID %>").style.display = "none";
            document.getElementById("<%=trUbicacion.ClientID %>").style.display = "none";
            document.getElementById("<%=trCanalVenta.ClientID %>").style.display = "none";
    ...
    <script type="text/javascript">
        function fc_TabChange(indiceTab) {
            ...
            if (document.getElementById("<%=this.txhNidUsuario.ClientID %>").value != "" && document.getElementById("<%=this.txhNidUsuario.ClientID %>").value != "0") {
                document.getElementById("tblHeader1").style.display = "";
                document.getElementById("tblHeader2").style.display = "";                
            }
            else {
                document.getElementById("tblHeader1").style.display = "none";
                document.getElementById("tblHeader2").style.display = "none";
            }
    ...
    <table id="Table5" cellpadding="0" cellspacing="0" border="0" width="800px" bordercolor="red">
    <tr>
        <td valign="bottom" style="width: 123px;">
            <table id="tblHeader0" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td><img id="img13" alt="" src="../Images/Tabs/tab-izq_off_plom.gif" /></td>
                    ...
                    <td><img id="img14" alt="" src="../Images/Tabs/tab-der_off_plom.gif" /></td>
                </tr>
            </table>
        </td>
        ...
        <td valign="bottom" style="width: 56px;">
            <table id="tblHeader1" cellpadding="0" cellspacing="0" border="0" >
                <tr>
                    <td><img id="imgTabIzq1" alt="" src="../Images/Tabs/tab-izq_off_plom.gif" /></td>
                    <td class="TabCabeceraOffForm" onclick="javascript: return fc_TabChangeEvento(1);" style="cursor:pointer"
                        ...
                        onmouseout="javascript: return onTabCabeceraOutForm('1');">Marca</td>
                    <td><img id="imgTabDer1" alt="" src="../Images/Tabs/tab-der_off_plom.gif" /></td>
                </tr>
            </table>
        </td>
        <td style="width: 5px;">&nbsp;</td>
        <td valign="bottom" style="width: 108px;">
            <table id="tblHeader2" cellpadding="0" cellspacing="0" border="0" >
                <tr>
                    <td><img id="img15" alt="" src="../Images/Tabs/tab-izq_off_plom.gif" /></td>
                    <td class="TabCabeceraOffForm" onclick="javascript: return fc_TabChangeEvento(2);" style="cursor:pointer"
                        onmouseover="javascript: return onTabCabeceraOverForm('2');"
                        onmouseout="javascript: return onTabCabeceraOutForm('2');">Perfil Asociado </td>
                    <td><img id="img16" alt="" src="../Images/Tabs/tab-der_off_plom.gif" /></td>
                </tr>
            </table>
       </td>
                        ...
                        <td style="background-color:#ffffff;vertical-align: top; height:450px; width:785px;">
                            <div id="idUsrMnt" class="DivCuerpoTab" runat="server" style="overflow: auto; height: 450px; width: 795px;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 35%"><asp:TextBox ID="txtNombres" runat="server" Width="250px" SkinID="txtob" MaxLength="30"></asp:TextBox></td>
                                    <td style="width: 15%">Ape. Paterno</td>
                                    <td style="width: 35%"><asp:TextBox ID="txtApePat" runat="server" Width="250px" SkinID="txtob" MaxLength="30"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>Ape. Materno</td>
                                    <td><asp:TextBox ID="txtApeMat" runat="server" Width="250px" MaxLength="30"></asp:TextBox></td>
                                    <td>DNI</td>
                                        <td>
                                ...
                                <tr>
                                    <td>Login</td>
                                    <td><asp:TextBox ID="txtLogin" runat="server" Width="150px" SkinID="txtob" MaxLength="20"></asp:TextBox></td>
                                    <td>Contraseña</td>
                                    <td><asp:TextBox ID="txtClave" TextMode="Password" runat="server" Width="150px" SkinID="txtob"
                                ...
                                <tr>
                                    <td>Correo</td>
                                    <td><asp:TextBox ID="txtCorreo" runat="server" Width="250px" SkinID="txtob" MaxLength="255"></asp:TextBox></td>
                                    <td>Teléfono</td>
                                    <td><asp:TextBox ID="txtTelefono" runat="server" Width="150px" MaxLength="50"></asp:TextBox></td>
                                </tr>                                
                                <tr>
                                    <td colspan="4"><hr /></td>
                                </tr>
                                <tr id="trNroBrevete" runat="server">
                                    <td id="tdNroBrevetetexto" style="width: 15%">
                                        Nro. de Brevete
                                    </td>
                                    <td id="tdNroBrevetecaja" style="width: 35%">
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtNroBrevete" runat="server" Width="200px"></asp:TextBox>
                                                <asp:Label ID="lblReqNBrevete" runat="server" Font-Names="Rod" ForeColor="Red" Text="(*)"></asp:Label>
                                                <br />
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cboPerfil" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                    </td>
                                    <td style="width: 15%">
                                        Vencimiento del Brevete
                                    </td>
                                    <td style="width: 35%">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                <uc1:Fecha ID="txtFecVencBrevete" runat="server" />
                                                <asp:Label ID="lblReqFBrevete" runat="server" Font-Names="Rod" ForeColor="Red" Text="(*)"></asp:Label>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cboPerfil" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                ...
                                <tr>
                                    ...
                                    <td>Perfil</td>
                                    <td><asp:DropDownList ID="cboPerfil" runat="server" AutoPostBack="true" OnSelectedIndexChanged="combos_SelectedIndexChanged" Width="240px" SkinID="cboob"></asp:DropDownList></td>
                                    <td><asp:CheckBox id="chkUpdateCombos" runat="server" AutoPostBack="true" OnCheckedChanged="combos_SelectedIndexChanged" /></td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <hr />
                                ...
                                <tr>
                                    <td>Empresa</td>
                                    <td>
                                    <asp:ListBox ID="cbo_empresa" runat="server" multiple="multiple" SelectionMode="Multiple"></asp:ListBox>
                                    </td>
                                </tr>  
                                <tr id="trHrJefeVenta" runat="server" >
                                    <td colspan="4"><hr /></td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:UpdatePanel ID="upCombos2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr id="trUbicacion" runat="server" style="height:25px">
                                                        <td style="width: 15%">Canal Venta</td>
                                                        <td style="width: 35%"><asp:DropDownList ID="cboCanalVenta" AutoPostBack="true" OnSelectedIndexChanged="cboCanalVenta_SelectedIndexChanged" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%">Punto de Venta</td>
                                                        <td style="width: 35%">&nbsp;<asp:DropDownList ID="cboPuntoVenta" AutoPostBack="true" OnSelectedIndexChanged="cboPuntoVenta_SelectedIndexChanged" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                    </tr>
                                                        <tr id="trUbicacionConc" runat="server" style="height:25px">
                                                            <td style="width: 15%">Canal Venta</td>
                                                            <td style="width: 35%"><asp:DropDownList ID="cboCanalVentaConc" AutoPostBack="true" OnSelectedIndexChanged="cboCanalVentaConc_SelectedIndexChanged" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                            <td style="width: 15%">Punto de Venta</td>
                                                            <td style="width: 35%">&nbsp;<asp:DropDownList ID="cboPuntoVentaConc" AutoPostBack="true" OnSelectedIndexChanged="cboPuntoVentaConc_SelectedIndexChanged" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        </tr>
                                                    <tr id="trCanalVentaAux" runat="server" style="height:25px">
                                                        <td style="width: 15%">Canal Venta</td>
                                                        <td style="width: 35%"><asp:DropDownList ID="cboCanalVentaAux" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%">&nbsp;&nbsp;&nbsp;</td>
                                                        <td style="width: 35%">&nbsp;&nbsp;&nbsp;</td>
                                                    </tr>
                                                    <tr id="trCanalVenta" runat="server" style="height:25px">
                                                        <td style="width: 15%">Ubicación</td>
                                                        <td style="width: 35%"><asp:DropDownList ID="cboUbicacion" AutoPostBack="true" OnSelectedIndexChanged="cboUbicacion_SelectedIndexChanged" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%"></td>
                                                        <td style="width: 35%"></td>
                                                    </tr>
                                                     <tr id="trUbicacionDependiente" runat="server" style="height:25px">
                                                        <td style="width: 15%">Ubicación</td>
                                                        <td style="width: 35%"><asp:DropDownList ID="cboUbicacionDependiente" AutoPostBack="true" OnSelectedIndexChanged="cboUbicacionDependiente_SelectedIndexChanged" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%"></td>
                                                        <td style="width: 35%"></td>
                                                    </tr>
                                                    <tr id="trAlmacenera" runat="server" >
                                                        <td style="width: 15%">Almacenera</td>
                                                        <td style="width: 35%">&nbsp;<asp:DropDownList ID="cboAlmacenera" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%"></td>
                                                        <td style="width: 35%"></td>
                                                    </tr>
                                                    <tr id="trJefeVenta" runat="server" style="height:25px">
                                                        <td style="width: 15%">Jefe de Venta</td>
                                                        <td style="width: 35%"><asp:DropDownList ID="cboJefeVenta" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%" id ="tdGerentetexto" runat="server">&nbsp;Gerente</td>
                                                        <td style="width: 35%" id ="tdGerentecombo" runat="server">&nbsp;<asp:DropDownList ID="cboGerente" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                    </tr>
                                                        <tr id="trGerenteConc" runat="server" style="height:25px">
                                                            <td style="width: 15%">Gerente</td>
                                                            <td style="width: 35%"><asp:DropDownList ID="cboGerenteConc" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                            <td style="width: 15%"></td>
                                                            <td style="width: 35%"></td>
                                                        </tr>
                                                    <tr id="trAgente" runat="server" >
                                                        <td style="width: 15%">Agente de Aduana</td>
                                                        <td style="width: 35%">&nbsp;<asp:DropDownList ID="cboAgente" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%"></td>
                                                        <td style="width: 35%"></td>
                                                    </tr>
                                                    <tr id="trAprobador" runat="server" >
                                                        <td style="width: 15%">Usu. Aprob. Venta Lib.</td>
                                                        <td style="width: 35%"><asp:DropDownList ID="cboAprobadorVentaLiberada" runat="server" Width="200px" SkinID="cboob"></asp:DropDownList></td>
                                                        <td style="width: 15%"></td>
                                                        <td style="width: 35%"></td>
                                                    </tr>
                                                </table>
                                            ...
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="chkUpdateCombos" EventName="CheckedChanged" />
                                                <asp:AsyncPostBackTrigger ControlID="cboCanalVenta" EventName="SelectedIndexChanged" />
                                                <asp:AsyncPostBackTrigger ControlID="cboPuntoVenta" EventName="SelectedIndexChanged" />
                                                    <asp:AsyncPostBackTrigger ControlID="cboCanalVentaConc" EventName="SelectedIndexChanged" />
                                                    <asp:AsyncPostBackTrigger ControlID="cboPuntoVentaConc" EventName="SelectedIndexChanged" />
                                                <asp:AsyncPostBackTrigger ControlID="cboUbicacionDependiente" EventName="SelectedIndexChanged" />
                                                <asp:AsyncPostBackTrigger ControlID="cboPerfil" EventName="SelectedIndexChanged" />
                                                <asp:AsyncPostBackTrigger ControlID="cboUbicacion" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Fec.    </td>
                                    <td><uc1:Fecha ID="txtFecIni" runat="server" /></td>
                                    <td>Fec. Fin Acceso</td>
                                    <td><uc1:Fecha ID="txtFecFin" runat="server" /></td>
                                </tr>
                                <tr>
                                    <td>Hora Inicio</td>
                                ...
                                <tr>
                                    <td>Mensaje</td>
                                    <td colspan="3"><asp:TextBox ID="txtMensaje" runat="server" TextMode="MultiLine" Rows="3" MaxLength="255" Width="640px"></asp:TextBox></td>
                                </tr>                                
                                <tr>
                                    <td colspan="4">
                                        <table border="0" style="width:100%">
                                            <tr>
                                                ...
                                                <td style="width: 15%"><asp:CheckBox ID="chkBloqueado" runat="server" Text="" /></td>
                                                <td style="width: 15%">Guías de Remisión</td>
                                                <td style="width: 15%"><asp:CheckBox ID="chkGuiasRemision" runat="server" Text="" /></td>
                                                <td style="width: 15%">Consulta de VIN</td>
                                                <td style="width: 15%"><asp:CheckBox ID="chkConsultaVIN" runat="server" Text="" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:UpdatePanel ID="UpdatePanel24" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table border="0" style="width:100%" bordercolor="red">
                                                    <tr>
                                                        <td style="width: 14%">No Disponible</td>
                                                        <td style="width: 4%">&nbsp;&nbsp;<asp:CheckBox ID="chkDisponible" runat="server" Text="" OnCheckedChanged="chkDisponible_CheckedChanged" AutoPostBack="true"/></td>
                                                        <td style="width: 41%"><asp:Label ID="lbl1erSuplente" runat="server" Visible="false" Text="1er Sup."></asp:Label>&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="cbo1erSuplente" runat="server" Width="250px" SkinID="cboob" Visible="false"></asp:DropDownList></td>
                                                        <td style="width: 41%"><asp:Label ID="lbl2doSuplente" runat="server" Visible="false" Text="2do Sup."></asp:Label>&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="cbo2doSuplente" runat="server" Width="250px" SkinID="cboob" Visible="false"></asp:DropDownList></td>                                                
                                                    </tr>
                                                </table>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="chkDisponible" EventName="CheckedChanged" />                                                
                                            </Triggers>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <table class="cbusqueda" style="width: 785px; height:30px" cellspacing="1" cellpadding="2" border="0">
                                            <tr align="left">
                                                ...
                                                <td style="width: 45%"><asp:TextBox ID="txtUsuarioPerfil" runat="server" Width="250px" SkinID="txtdes" ReadOnly="true"></asp:TextBox></td>
                                                <td style="width: 10%">Perfil</td>
                                                <td style="width: 35%"><asp:TextBox ID="txtUsuarioPerfilDsc" runat="server" Width="150px" SkinID="txtdes"
                                                        ReadOnly="true"></asp:TextBox></td>
                                            </tr>
                                        </table>
                                        <table cellpadding="0" cellspacing="0" width="785px">
                                            <tr>
                                                <td><asp:Image ID="Image2" runat="server" ImageUrl="~/Images/iconos/fbusqueda.gif" Width="785px" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
<asp:Content ContentPlaceHolderID="cphFormPost" ID="cphFormPost" runat="server">
    <script type="text/javascript">
        ...
        function cargarcombo() {
            $("#<%=this.cbo_empresa.ClientID %>").multiselect({ height: "120px" });
        }
